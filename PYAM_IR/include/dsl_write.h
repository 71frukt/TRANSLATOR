...
#define IRCALL_FUNC_(return_value_, func_num_, cnt_args_, comment)                                 \
        fprintf(                                                                                    \
            IR_file,                                                                                \
            "\n\t%s(tmp%zu, func_%zu_%zu)\t# %s\n\n",                                               \
            kIR_KEY_WORD_ARRAY[IR_FUNCTIONCALL_INDEX],                                             \
            return_value_,                                                                          \
            func_num_,                                                                              \
            cnt_args_,                                                                              \
            comment                                                                                 \
...
#define IRCALL_MAIN_(return_value_)                                                                \
        fprintf(                                                                                    \
            IR_file,                                                                                \
...
#define IR_SYSCALL_(return_value_, syscall_name_, arg_cnt_)                                         \
        fprintf(                                                                                    \
            ...
            kIR_KEY_WORD_ARRAY[IR_SYSTEM_FUNCTIONCALL_INDEX],                                      \
            return_value_,                                                                          \
            syscall_name_,                                                                          \
            arg_cnt_,                                                                               \
            syscall_name_                                                                           \
