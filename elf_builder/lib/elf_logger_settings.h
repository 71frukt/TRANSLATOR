#ifndef ELF_LOGGER_SETTINGS_H
#define ELF_LOGGER_SETTINGS_H
...
#define ELF_LOGGER_SETTINGS_PREAMBLE  COLORS_HTML_PREAMBLE TABLE_HTML_COLOR

#endif /*ELF_LOGGER_SETTINGS_H*/